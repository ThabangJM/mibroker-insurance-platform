...
function App() {
  ...
  const [currentView, setCurrentView] = useState<'home' | 'quote' | 'dashboard' | 'comparison' | 'analytics' | 'policies' | 'about' | 'representative-assignment' | 'thank-you'>('home');
  ...
  return (
    <NotificationProvider>
      <div className="min-h-screen bg-gray-50">
        ...
        <Footer onInsuranceTypeSelect={handleInsuranceTypeSelect} />
      </div>
    </NotificationProvider>
  );
}
